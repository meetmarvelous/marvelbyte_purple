...
if (isset($_POST["imgchange1"])) {
  ...
  $fileInfo['extension'] = strtolower($fileInfo['extension']);
    ...
    $imgchange1 = mysqli_query($con, "UPDATE site_info SET header_logo='$newFileName' where site_id='$getid' ");
...
if (isset($_POST["imgchange2"])) {
  ...
  $fileInfo['extension'] = strtolower($fileInfo['extension']);
    ...
    $imgchange2 = mysqli_query($con, "UPDATE site_info SET footer_logo='$newFileName' where site_id='$getid' ");
...
if (isset($_POST["iconchange"])) {
  ...
  $fileInfo['extension'] = strtolower($fileInfo['extension']);
    ...
    $iconchange = mysqli_query($con, "UPDATE site_info SET icon='$newFileName' where site_id='$getid' ");
